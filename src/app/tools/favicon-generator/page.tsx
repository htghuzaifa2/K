...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'A free online tool to generate all necessary favicon sizes (16x16, 32x32, 192x192, etc.) from a single image. Create favicons for your website instantly.',
    openGraph: {
        title: `${tool.title} | ${APP_NAME}`,
        description: `Use the ${tool.title} tool to generate favicons.`,
        type: 'website',
    }
  };
}
