...
const sentences = [
  ...
  "ایک دوست دوسرے سے: یار، میری بیوی بہت شک کرتی ہے۔ دوسرا دوست: کیوں، کیا ہوا؟ پہلا دوست: کل میں نے خواب میں کسی لڑکی کا نام لیا، صبح اٹها تو میری آدھی تنخواہ غائب تھی۔"
];
